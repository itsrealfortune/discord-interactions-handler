...
interface StringSelectMenuInteractionLike
...
interface UserSelectMenuInteractionLike
	extends MessageComponentInteractionLike {
	data?: InteractionData & {
...
interface RoleSelectMenuInteractionLike
	extends MessageComponentInteractionLike {
	data?: InteractionData & {
...
interface MentionableSelectMenuInteractionLike
	extends MessageComponentInteractionLike {
	data?: InteractionData & {
...
interface ChannelSelectMenuInteractionLike
	extends MessageComponentInteractionLike {
	data?: InteractionData & {
...
type InteractionEventListener<E extends InteractionEventName> = (
...
declare class InteractionHandler extends EventEmitter {
	...
	emitMessageComponent(
		interaction: MessageComponentInteractionLike,
	): Promise<void>;
	...
	reply(
		...
		| (Response &
				hono.TypedResponse<"Missing interaction ID or token", 400, "text">)
		| (Response &
				hono.TypedResponse<
					{
						type: number;
					...
					hono_utils_http_status.ContentfulStatusCode,
					"json"
				>);
